...
class Planet:
    ...
    def draw(self, win):
        # Width and height divided by 2 gives the offset to center the planet in game screen
        ...
        if len(self.orbit) > 2:
            ...
            for point in self.orbit:
                ox, oy = point
                ox = ox * self.SCALE + WIDTH / 2
                oy = oy * self.SCALE + HEIGHT / 2
    ...
    def update_position(self, planets: list[Planet]):
        ...
        # Increasing velocity by the acceleration * timestep
